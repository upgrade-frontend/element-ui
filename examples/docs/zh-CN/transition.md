...
```js
// fade/zoom 等
import '@upgrade-frontend/element-ui/lib/theme-chalk/base.css';
// collapse 展开折叠
import CollapseTransition from '@upgrade-frontend/element-ui/lib/transitions/collapse-transition';
import Vue from 'vue'
