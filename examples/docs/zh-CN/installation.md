...
```shell
npm i @upgrade-frontend/element-ui -S
...
目前可以通过 [unpkg.com/@upgrade-frontend/element-ui](https://unpkg.com/@upgrade-frontend/element-ui/) 获取到最新版本的资源，在页面上引入 js 和 css 文件即可开始使用。
