...
import locale from '@upgrade-frontend/element-ui/lib/locale/lang/en'
...
import lang from '@upgrade-frontend/element-ui/lib/locale/lang/en'
import locale from '@upgrade-frontend/element-ui/lib/locale'
...
{
  plugins: [
    new webpack.NormalModuleReplacementPlugin(/@femessage[\/\\]element-ui[\/\\]lib[\/\\]locale[\/\\]lang[\/\\]zh-CN/, '@upgrade-frontend/element-ui/lib/locale/lang/en')
  ]
}
```
...
import enLocale from '@upgrade-frontend/element-ui/lib/locale/lang/en'
import zhLocale from '@upgrade-frontend/element-ui/lib/locale/lang/zh-CN'
...
import enLocale from '@upgrade-frontend/element-ui/lib/locale/lang/en'
import zhLocale from '@upgrade-frontend/element-ui/lib/locale/lang/zh-CN'
import ElementLocale from '@upgrade-frontend/element-ui/lib/locale'
...
<script src="//unpkg.com/@upgrade-frontend/element-ui"></script>
<script src="//unpkg.com/@upgrade-frontend/element-ui/lib/umd/locale/en.js"></script>
...
<script src="//unpkg.com/@upgrade-frontend/element-ui"></script>
<script src="//unpkg.com/@upgrade-frontend/element-ui/lib/umd/locale/zh-CN.js"></script>
<script src="//unpkg.com/@upgrade-frontend/element-ui/lib/umd/locale/en.js"></script>
